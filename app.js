...
var UIController = (function() {
    ...
    return {
        getInput: function() {
            return {
                // return an object instead three var
...
var controller = (function(budgetCtrl, UICtrl) {
    ...
    var updatePercentages = function() {
        ...
        // 3. Updatet the UI with the new percentages
    ...
    var ctrlDeleteItem = function(event) {
        ...
        if (itemID) {
            ...
            budgetCtrl.deketeItem(type, ID);

            // 2. Delete the item from te UI
